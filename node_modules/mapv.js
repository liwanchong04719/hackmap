(function (global, factory) {
                ...
                */
                ...
                /**
                 * Created by zhongxiaoming on 2016/12/6.
                 */
                /**
                 * 增加leaflet地图支持
                 */

                function CanvasLayer$2(options) {
                  this.options = options || {};

                  this.zIndex = this.options.zIndex || 0;

                  this._map = options.map;
                  this._initialize(this._map);
                ...
                if (global$4.LMap) {
                  ...
                  CanvasLayer$2.prototype.onAdd = function (map) {
                    this.map = map;
                  ...
                  CanvasLayer$2.prototype._initialize = function (map) {
                  ...
                  CanvasLayer$2.prototype.adjustSize = function () {
                  ...
                  CanvasLayer$2.prototype._draw = function () {
                    var map = this._map;
                    var size = map.getSize();
                    var center = map.getCenter();
                    this.adjustSize();
                    if (center) {
                      var pixel = map.latLngToContainerPoint(center);
                      this.canv.style.left = pixel.x - size.x / 2 + 'px';
                      this.canv.style.top = pixel.y - size.y / 2 + 'px';
                      //this.dispatchEvent('draw');
                      this.options.update && this.options.update.call(this);
                    }
                  };

                  CanvasLayer$2.prototype.getContainer = function () {
                    return this.canv;
                  };

                  CanvasLayer$2.prototype.show = function () {
                    if (!this.canv) {
                      this._map.addOverlay(this);
                    }
                  ...
                  CanvasLayer$2.prototype.hide = function () {
                    this.canv.style.display = "none";
                    //this._map.removeOverlay(this);
                  };

                  CanvasLayer$2.prototype.setZIndex = function (zIndex) {
                    this.canv.style.zIndex = zIndex;
                  };

                  CanvasLayer$2.prototype.getZIndex = function () {
                    return this.zIndex;
                  };
                }
                ...
                function Layer$2(map, dataSet, options) {
                  ...
                  var canvasLayer = this.canvasLayer = new CanvasLayer$2((_ref = {
                    map: map,
                    paneName: options.paneName,
                    mixBlendMode: options.mixBlendMode,
                    zIndex: options.zIndex,
                    ...
                    boolPixelCrs: options.boolPixelCrs,
                    mecator: options.transform

                  }, defineProperty(_ref, "zIndex", options.zIndex), defineProperty(_ref, "visible", options.visible), defineProperty(_ref, "update", update), _ref));
                  ...
                  function update(time) {
                    ...
                    var dataGetOptions = {
                      transferCoordinate: function transferCoordinate(coordinate) {
                        var point = map.latLngToContainerPoint(L.latLng(coordinate[1], coordinate[0]));
                ...
                Layer$2.prototype.onAdd = function () {
                  this.canvasLayer._initialize(this.map);
                  this.options.animation = true;
                };

                Layer$2.prototype.onRemove = function () {
                  this.map.getPanes().tilePane.removeChild(this.canvasLayer._div);
                  //this.options.animation.enabled = false;
                  //map.off('moveend', this._redraw, this);
                };

                Layer$2.prototype.argCheck = function (options) {
                  if (options.draw == 'heatmap') {
                    if (options.strokeStyle) {
                      console.warn('[heatmap] options.strokeStyle is discard, pleause use options.strength [eg: options.strength = 0.1]');
                    }
                ...
                Layer$2.prototype.init = function (options) {
                  var self = this;
                ...
                Layer$2.prototype.show = function () {
                  this.map.addOverlay(this.canvasLayer);
                };

                Layer$2.prototype.hide = function () {
                  this.map.removeOverlay(this.canvasLayer);
                };
                 ...
                 * obj.options
                 */
                Layer$2.prototype.update = function (obj) {
                  var self = this;
                  var _options = obj.options;
                  var options = self.options;
                  for (var i in _options) {
                ...
                Layer$2.prototype.set = function (obj) {
                  var conf = {
                    globalAlpha: 1,
                    globalCompositeOperation: 'source-over',
                    imageSmoothingEnabled: true,
                ...
                exports.leafletMapCanvasLayer = CanvasLayer$2;
                exports.leafletMapLayer = Layer$2;
